...
# --- DATA LOADING (Direct from Google Drive) ---
@st.cache_data(show_spinner="Syncing with 10-Year Crime Database...")
def load_data():
    # Your file ID from the link provided
    file_id = "1TIKj3UxtW1HUFBeDri3kh-keu5d8ETrK"
    url = f"https://drive.google.com/uc?export=download&id={file_id}"
    
    try:
        # low_memory=False is essential for the large 2015-2025 dataset
        ...
        # Categorization for Statistical Analysis
...
if df is not None:
    ...
    with tab2:
        ...
        # Sampled for performance on the Streamlit Cloud free tier
    ...
    st.info("Awaiting secure connection to Google Drive...")
